...
# }
# small
sd['condition_provider.conditioners.description.output_proj.weight'] = torch.zeros((512, 1024), device=device)
sd['condition_provider.conditioners.description.output_proj.bias'] = torch.zeros((512), device=device)
# # medium
